...
Name:
<br>
<input type="text" name="UserName" value="<?=$_SESSION['UserName']?>"><span class="error">* <?php echo $UserNameErr;?></span>
<br><br>
E-mail:
<p>
<input type="email" name="UserEmail" value="<?=$_SESSION['UserEmail']?>"><span class="error">* <?php echo $UserEmailErr;?></span>
<br><br>
Password:
<p>
...
Skills:
<p>
<input type="text" name="UserSkills" value="<?=$_SESSION['UserSkills']?>"><span class="error">* <?php echo $UserSkillsErr;?></span>
<br><br>
<img src="Captcha/render_captcha.php?s=FFFFFF_00_173_50&t=<?=$GeneratedCaptcha?>" alt="Error while generating captcha text...">
<br><br>
Please enter text from image in the form below (case sensitive):<p>
